    ...
    <section id="home" className="relative min-h-screen flex flex-col overflow-hidden">
      ...
      <div className="relative z-10 flex-1 flex flex-col justify-center px-4 py-20 md:py-28">
        <div className="max-w-6xl mx-auto w-full">
          ...
          {/* SECONDARY META SECTION: Location + Availability (single row) */}
          <div className={`text-center mb-10 transition-all duration-1000 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          ...
          <div className={`flex flex-wrap items-center justify-center gap-5 mb-14 transition-all duration-1000 delay-150 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <Button 
            ...
            <Button 
              variant="outline" 
              className="border-border text-foreground hover:bg-primary/10 hover:border-primary px-8 py-6 text-lg hover:-translate-y-0.5 transition-all duration-200"
              asChild
            >
          ...
          {/* SOCIAL LINKS SECTION: Pill-style cards */}
          ...
          {/* SINGLE DOWN ARROW - Scroll cue */}
          <div className={`text-center mb-14 transition-all duration-1000 delay-300 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
            <button 
          ...
          {/* CURRENTLY EXPLORING: Hero footer context */}
